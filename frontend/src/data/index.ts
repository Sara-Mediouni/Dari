...
export const navItems = [
  ...
  export const testimonials = [
    ...
    {id:4,
      ...
      name: "Yoyo/Tunisian Doughnut",
      image: assets.yoyo
    },
    {id:5,
      quote:
        "Ghraiba Homs is a type of Middle Eastern shortbread cookie made with semolina, ghee (clarified butter), and homs (ground chickpeas).",
      name: " Chickpea cookies/Ghrayba Hummus",
      image: assets.ghraiba
    },
    {id:6,
        quote:
          "Kaak Anbar is a traditional Middle Eastern pastry, especially popular in Lebanon, Syria, and Jordan. It is a type of sweet bread or cookie made with ingredients such as flour, sugar, ghee (clarified butter), and sometimes anise seeds.",
        name: " Kaak Anber",
        image: assets.kaakanber
      },
  ];