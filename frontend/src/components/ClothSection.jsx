  ...
  return (
    ...
    <div className="max-w-screen-xl mx-auto text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-100 feature p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          <img src={assets.coffins} alt="Pâtisserie 1" className="w-full h-64 object-cover rounded-lg mb-4" />
          <h3 className="text-xl font-semibold text-gray-700 mb-2">Revisited artisanal baskets</h3>
        ...
        <div className="bg-gray-100 feature p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <h3 className="text-xl font-semibold text-gray-700 mb-2">Tea-pots</h3>
        ...
        <div className="bg-gray-100 feature p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
          ...
          <h3 className="text-xl font-semibold text-gray-700 mb-2">Our revisited artisanal tables</h3>
